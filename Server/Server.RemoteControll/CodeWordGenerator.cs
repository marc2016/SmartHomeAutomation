...
namespace Server.RemoteControl
{
    public class CodeWordGenerator
    {
        ...
        {
            var result = Convert.ToString(dec, 2);
        ...
        public static string GetCodeWordB(int addressCode, int channelCode, bool status)
        {
            ...
            {
                var result = code[addressCode] + code[channelCode] + "FFF";
                result += status ? "F" : "0";
                return result;
            }
            return string.Empty;
        ...
        public static string GetCodeWordC(char family, int group, int device, bool status)
        {
            ...
            var deviceGroupCode = DecimalToBinary(device - 1 + (group - 1) * 4, 4);
            string[] familycode = {"0000", "F000", "0F00", "FF00", "00F0", "F0F0", "0FF0", "FFF0", "000F", "F00F", "0F0F", "FF0F", "00FF", "F0FF", "0FFF", "FFFF"};
            result += familycode[family - 97];
        ...
        public static string GetCodeWordD(string group, int channelCode, bool status)
        {
            ...
            */
            ...
            var str = Convert.ToString(channelCode, 2);
